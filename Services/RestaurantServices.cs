...
namespace RestaurantAPI.Services
{
    ...
    public class RestaurantServices : IRestaurantServices
    {
        ...
        public RestaurantServices(RestaurantDbContext dbContext, 
            IMapper mapper, 
            ILogger<RestaurantServices> logger,
        ...
        public PageResult<RestaurantDto> GetAll(RestaurantQuery query)
        {
            var baseQuery = _dbContext
                ...
                .Include(r => r.Address)
                .Include(r => r.Dishes)
                .Where(r => query.SearchParse == null || (r.Name.ToLower().Contains(query.SearchParse.ToLower()) ||
                                                          r.Description.ToLower()
                                                              .Contains(query.SearchParse.ToLower())));
